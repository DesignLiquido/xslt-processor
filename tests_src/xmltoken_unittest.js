...
window.testXmlVersionInfo = function() {
    const okVersion10 = [
        ' version="1.0"',
        ' version  =   "1.0"',
        '\tversion\t\t=\t\t\t"1.0"',
...
// Test XML_CHAR_REF.
window.testXmlCharRef = function() {
    const okCharRef = [
        '&#0;',
        '&#9;',
        '&#32;', // ' '
...
window.testXmlEntityRef = function() {
    const okEntityRef = [
