...
describe('LMHT', () => {
    ...
    it('Form Fieldset', async () => {
        ...
        <corpo>
            <titulo1>Editar Artigo</titulo1>
            <formulário método="POST" ação="/artigos/{{id}}/editar">
                <campos>
                    <campo tipo="escondido" id="id" />
                    <etiqueta para="id">id</etiqueta>
                    <campo tipo="texto" id="id" valor="{{id}}" />
                    <etiqueta para="titulo">titulo</etiqueta>
                    <campo tipo="texto" id="titulo" valor="{{titulo}}" />
                    <etiqueta para="conteudo">conteudo</etiqueta>
                    <campo tipo="texto" id="conteudo" valor="{{conteudo}}" />
    
                    <campo tipo="enviar" valor="Atualizar" />
